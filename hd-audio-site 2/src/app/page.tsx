...
const CategoryCard = ({ title }: { title: string }) => (
  <div className="group relative bg-gray-100 h-[450px] overflow-hidden cursor-pointer">
    ...
    <div className="absolute top-0 left-0 w-full h-full bg-gray-200 animate-pulse group-hover:scale-105 transition-transform duration-700 flex items-center justify-center text-gray-400 font-bold italic opacity-20 text-4xl uppercase">
      {title}
    </div>
  </div>
);
