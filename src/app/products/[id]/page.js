...
const productData = {
  '15tbx100': {
    ...
    moreImages: [
      ...
      'https://sc02.alicdn.com/kf/H056f7e48a2e1461ca42d67e56972ece8r.jpg' // 参数全图
    ],
    specs: [
      { label: 'Nominal Diameter', value: '380 mm (15.0 in)' },
      { label: 'Power Handling (AES)', value: '1000 W' },
      { label: 'Maximum Power Handling', value: '2000 W' },
      ...
      { label: 'Vas (Equivalent Air Volume)', value: '128.0 L' },
      { label: 'Xmax (Max Linear Excursion)', value: '9.0 mm' }
    ]
  },
  '18tbx100': {
    ...
    moreImages: [
      ...
      'https://sc02.alicdn.com/kf/He7d177cd30334844a7fdff2b15490b16a.jpg' // 参数全图
    ],
    specs: [
      ...
      { label: 'Voice Coil Diameter', value: '100 mm (4.0 in)' },
      { label: 'Fs (Resonant Frequency)', value: '35 Hz' },
      { label: 'Qts (Total Q)', value: '0.33' },
      { label: 'Vas (Equivalent Air Volume)', value: '265.0 L' }
    ]
  },
  '21nc152': {
    ...
    moreImages: [
      ...
      'https://sc02.alicdn.com/kf/H7a38dfdb74e149578858fd80a88a27d07.jpg' // 参数全图
    ],
    specs: [
      { label: 'Nominal Diameter', value: '530 mm (21.0 in)' },
      { label: 'Power Handling (AES)', value: '2000 W' },
      { label: 'Maximum Power Handling', value: '4000 W' },
...
export default function ProductDetail() {
  ...
  if (!product) return <div className="pt-48 text-center text-black">Technical Node Offline.</div>;

  return (
    <div className="bg-white min-h-screen pt-32 pb-24 px-8 text-black selection:bg-blue-600 selection:text-white">
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 text-left">
        ...
        <div className="flex flex-col justify-center">
          <h1 className="text-[14px] font-bold text-blue-600 tracking-[0.5em] uppercase mb-6">CoreTone Precision Driver</h1>
