...
export default function ProductDetailPage() {
  ...
  const db = {
    '21nc152': { 
      ...
      specs: { 'Power': '4000W Peak', 'Fs': '32 Hz', 'Re': '3.3 Ohm', 'Qes': '0.32', 'Qms': '6.3', 'Qts': '0.30', 'Vas': '168 L', 'Sd': '1680 cm²', 'Mms': '460 g', 'BL': '32.5 T.m', 'Le': '1.5 mH' } 
    },
    '18tbx100': { 
      ...
      specs: { 'Power': '2400W Peak', 'Fs': '30 Hz', 'Re': '5.1 Ohm', 'Qes': '0.33', 'Qms': '7.0', 'Qts': '0.31', 'Vas': '256 L', 'Sd': '1210 cm²', 'Mms': '209 g', 'BL': '25.5 T.m', 'Le': '1.6 mH' } 
    },
    '15tbx100': { 
      ...
      specs: { 'Power': '2000W Peak', 'Fs': '35 Hz', 'Re': '5.1 Ohm', 'Qes': '0.30', 'Qms': '5.2', 'Qts': '0.28', 'Vas': '113 L', 'Sd': '855 cm²', 'Mms': '163 g', 'BL': '22.1 T.m', 'Le': '1.5 mH' } 
    },
    '10nw64': { 
      name: '10NW64 10" Professional Neodymium Woofer', cat: 'LF Driver', 
      imgs: ['https://sc02.alicdn.com/kf/A927cc47369c54ce28f6a0d4883609a7a6.png', 'https://sc02.alicdn.com/kf/H0aae43527a3e4f05a748066d0035ca0aQ.jpg', 'https://sc02.alicdn.com/kf/H6b31a62135254b64ac8de6a39fcfe683h.jpg', 'https://sc02.alicdn.com/kf/Hf93507b974e14066965e6ce2d508e6059.jpg', 'https://sc02.alicdn.com/kf/Acc5b5848d22c4951a177de359b32edfa2.png'], 
      specs: { 'Power': '600W Cont.', 'Fs': '59 Hz', 'Re': '5.2 Ohm', 'Qes': '0.27', 'Qms': '4.3', 'Qts': '0.25', 'Vas': '26 L', 'Sd': '320 cm²', 'Mms': '47 g', 'BL': '18.3 T.m', 'Le': '0.6 mH' },
    ...
    '12ndl76': { 
      ...
      imgs: ['https://sc02.alicdn.com/kf/Af414e56b3b954c16a1a87934dc56284es.png', 'https://sc02.alicdn.com/kf/H0c065ca85a044873a0e04aedb2063de0W.jpg', 'https://sc02.alicdn.com/kf/H6b31a62135254b64ac8de6a39fcfe683h.jpg', 'https://sc02.alicdn.com/kf/H13eb77b0713c4712a3a6dd5cd5e55398l.jpg'], 
      specs: { 'Power': '800W Peak', 'Fs': '50 Hz', 'Re': '5.3 Ohm', 'Qes': '0.21', 'Qms': '4.2', 'Qts': '0.20', 'Vas': '73 L', 'Sd': '522 cm²', 'Mms': '53 g', 'BL': '17.7 T.m', 'Le': '1.2 mH' } 
    }
  };

  const p = id ? db[id] : null;

  if (!p) return <div className="pt-48 text-center bg-[#0A0A0A] min-h-screen text-white font-mono uppercase text-xs">Asset Node Tracking...</div>;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-5 gap-2">
            {p.imgs.map((img, i) => (
              <div key={i} className="bg-[#141414] border border-[#262626] p-2 aspect-square flex items-center justify-center overflow-hidden">
        ...
        <div className="space-y-12">
          <div>
            ...
            <p className="text-[#A3A3A3] text-[11px] font-mono uppercase tracking-widest italic border-l-2 border-[#E11D48] pl-4">Engineering Asset Verified</p>
          </div>
