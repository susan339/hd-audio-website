...
export default function ProductDetailPage({ params }) {
  ...
  const db = {
    ...
    '21nc152': { 
      ...
      imgs: ['https://sc02.alicdn.com/kf/Hf3f2d988eaf0468db650dd2d05e6f088i.jpg', 'https://sc02.alicdn.com/kf/H6b31a62135254b64ac8de6a39fcfe683h.jpg'], 
    ...
    '10nw64': { 
      ...
      imgs: ['https://sc02.alicdn.com/kf/A927cc47369c54ce28f6a0d4883609a7a6.png', 'https://sc02.alicdn.com/kf/H0aae43527a3e4f05a748066d0035ca0aQ.jpg', 'https://sc02.alicdn.com/kf/H13eb77b0713c4712a3a6dd5cd5e55398l.jpg', 'https://sc02.alicdn.com/kf/Acc5b5848d22c4951a177de359b32edfa2.png'], 
    ...
    '15tbx100': { 
      ...
      imgs: ['https://sc02.alicdn.com/kf/H0aae43527a3e4f05a748066d0035ca0aQ.jpg', 'https://sc02.alicdn.com/kf/H13eb77b0713c4712a3a6dd5cd5e55398l.jpg'], 
  ...
  const p = db[id];
  if (!p) return <div className="pt-48 text-center bg-[#0A0A0A] min-h-screen text-white uppercase font-mono tracking-widest">Asset Not Found</div>;

  return (
    <div className="pt-32 pb-24 max-w-[1500px] mx-auto px-6 bg-[#0A0A0A] text-white min-h-screen">
      <Link href="/products" className="text-[#A3A3A3] hover:text-white text-[10px] uppercase mb-12 inline-block font-mono tracking-widest">← Back to Collection</Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          {p.imgs.length > 1 && (
            <div className="grid grid-cols-4 gap-4">
              {p.imgs.slice(1).map((img, i) => (
                <div key={i} className="bg-[#141414] border border-[#262626] p-4 aspect-square flex items-center justify-center overflow-hidden hover:border-[#E11D48] transition-colors cursor-pointer">
        ...
        <div className="space-y-12">
          <div>
            <span className="px-3 py-1 bg-[#E11D48]/10 text-[#E11D48] text-[9px] font-mono uppercase tracking-[0.2em] border border-[#E11D48]/20">{p.cat}</span>
