...
export default function ProductDetailPage({ params }) {
  ...
  const db = {
    '21nc152': { 
      ...
      specs: { 'Power': '4000W Peak', 'AES': '2000W', 'Fs': '32 Hz', 'Re': '3.3 Ohm', 'Qts': '0.30', 'Vas': '168 L', 'Sd': '1680 cm²', 'Mms': '460 g', 'BL': '32.5 T.m', 'Voice Coil': '153mm (6")', 'Sensitivity': '97dB' } 
    },
    '18tbx100': { 
      ...
      specs: { 'Power': '2400W Peak', 'AES': '1200W', 'Fs': '30 Hz', 'Re': '5.1 Ohm', 'Qts': '0.31', 'Vas': '256 L', 'Sd': '1210 cm²', 'Mms': '209 g', 'BL': '25.5 T.m', 'Voice Coil': '100mm (4")', 'Sensitivity': '98dB' } 
    },
    '15tbx100': { 
      ...
      specs: { 'Power': '2000W Peak', 'AES': '1000W', 'Fs': '35 Hz', 'Re': '5.1 Ohm', 'Qts': '0.28', 'Vas': '113 L', 'Sd': '855 cm²', 'Mms': '163 g', 'BL': '22.1 T.m', 'Voice Coil': '100mm (4")', 'Sensitivity': '96dB' } 
    },
    '10nw64': { 
      ...
      specs: { 'Power': '600W Max', 'Fs': '59 Hz', 'Re': '5.2 Ohm', 'Qts': '0.25', 'Vas': '26 L', 'Sd': '320 cm²', 'Mms': '47 g', 'BL': '18.3 T.m', 'Voice Coil': '64mm (2.5")', 'Sensitivity': '96dB' },
    ...
    '12ndl76': { 
      ...
      specs: { 'Power': '800W Peak', 'Fs': '50 Hz', 'Re': '5.3 Ohm', 'Qts': '0.20', 'Vas': '73 L', 'Sd': '522 cm²', 'Mms': '53 g', 'BL': '17.7 T.m', 'Voice Coil': '76mm (3")', 'Sensitivity': '100dB' } 
    }
  };

  const p = id ? db[id] : null;
  if (!p) return <div className="pt-48 text-center bg-[#0A0A0A] min-h-screen text-white uppercase font-mono text-xs">Asset Node Tracking... NULL</div>;
