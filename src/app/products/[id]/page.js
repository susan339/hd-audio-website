...
const db = {
  '21nc152': {
    ...
    main: 'https://sc02.alicdn.com/kf/Ae6126836c5404d778810df5af8276f7dD.png',
    pdf: 'https://sc02.alicdn.com/kf/H59244c55478f482097993793a0e721c3f.jpg',
    imgs: ['https://sc02.alicdn.com/kf/Ae6126836c5404d778810df5af8276f7dD.png', 'https://sc02.alicdn.com/kf/Hf3f2d988eaf0468db650dd2d05e6f088i.jpg', 'https://sc02.alicdn.com/kf/H6b31a62135254b64ac8de6a39fcfe683h.jpg', 'https://sc02.alicdn.com/kf/H59244c55478f482097993793a0e721c3f.jpg'],
    specs: [{ l: 'Power', v: '4000W Peak' }, { l: 'Fs', v: '32 Hz' }, { l: 'Qts', v: '0.30' }, { l: 'Vas', v: '168 L' }, { l: 'Sens', v: '97 dB' }]
  },
  '18tbx100': {
    ...
    specs: [{ l: 'Power', v: '2400W Peak' }, { l: 'Fs', v: '30 Hz' }, { l: 'Qts', v: '0.31' }, { l: 'Sens', v: '98 dB' }]
  },
  '15tbx100': {
...
export default function ProductDetail() {
  ...
  if (!p) return <div style={{ paddingTop: '200px', textAlign: 'center', backgroundColor: 'white', minHeight: '100vh' }}>Node Offline</div>;
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px' }}>
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '12px', marginTop: '24px' }}>
            {p.imgs.map((img, i) => (
              <div key={i} onClick={() => setDisp(img)} style={{ border: disp === img ? '2px solid black' : '1px solid #dee2e6', padding: '4px', cursor: 'pointer', backgroundColor: 'white' }}>
        ...
        <div>
          <Link href="/products" style={{ color: '#adb5bd', textDecoration: 'none', fontSize: '12px', fontWeight: 'bold' }}>← BACK TO CATALOG</Link>
          <h2 style={{ fontSize: '56px', fontWeight: '900', textTransform: 'uppercase', margin: '32px 0' }}>{p.name}</h2>
          <div style={{ border: '1px solid #dee2e6', backgroundColor: 'white', marginBottom: '48px' }}>
            <div style={{ padding: '16px 40px', backgroundColor: '#f8f9fa', borderBottom: '1px solid #dee2e6', fontSize: '10px', fontWeight: 'bold', color: '#adb5bd' }}>TECHNICAL DATA</div>
            {p.specs.map(s => (
              <div key={s.l} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', padding: '16px 40px', borderBottom: '1px solid #f1f3f5' }}>
                <span style={{ color: '#adb5bd', fontSize: '13px' }}>{s.l}</span>
                <span style={{ textAlign: 'right', fontWeight: 'bold' }}>{s.v}</span>
              </div>
            ))}
          </div>
          <div style={{ display: 'flex', gap: '24px' }}>
            <a href="https://wa.me/8615521083699" target="_blank" style={{ flex: 1, backgroundColor: '#007bff', color: 'white', textAlign: 'center', padding: '24px', textDecoration: 'none', fontWeight: 'bold' }}>INQUIRY NOW</a>
            <a href={p.pdf} target="_blank" style={{ flex: 1, border: '2px solid black', color: 'black', textAlign: 'center', padding: '24px', textDecoration: 'none', fontWeight: 'bold' }}>DOWNLOAD PDF</a>
          </div>
        </div>
      </div>
    </div>
