...
export default function HomePage() {
  ...
  return (
    <div className="bg-white selection:bg-[#2563EB] selection:text-white">
      {/* SECTION 1: HERO - PURIFIED MIRROR */}
      <section className="relative h-screen bg-black overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto w-full px-8 pt-20">
          <div className="max-w-4xl text-left">
            {/* 21 | 18 | 15 文字下移定位 */}
            <div className="text-gray-400 text-[24px] font-normal tracking-[0.3em] uppercase mb-12 opacity-80">21” | 18” | 15”</div>
            ...
            <h1 className="text-[96px] font-black leading-[1] text-white tracking-[-4.8px] mb-4 uppercase">PRO AUDIO</h1>
            <h1 className="text-[96px] font-black leading-[1] tracking-[-4.8px] mb-10 uppercase text-white/20" style={{WebkitTextStroke: '1px rgba(255,255,255,0.4)'}}>DRIVERS & SYSTEMS</h1>
            
            <p className="text-white text-[24px] font-bold tracking-[0.1em] mb-16 uppercase leading-tight max-w-2xl">
            ...
            <div className="flex gap-6">
              ...
              <button onClick={() => window.location.href='https://wa.me/8615521083699'} className="border border-white text-white px-10 py-5 font-bold text-sm tracking-[0.2em] uppercase hover:bg-white hover:text-black transition-all">ABOUT US</button>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-12">
              {[
                ...
                <div key={item.id} className="flex gap-8 group">
                  <span className="text-[#3B82F6] font-black text-xl leading-none mt-1">{item.id}</span>
                  <div>
      ...
      {/* SECTION 3: ONE-STOP SERVICE (RESTORED) */}
      <section className="bg-white py-32 px-8 border-t border-zinc-100 text-center">
        <h2 className="text-[60px] font-black leading-[1] tracking-[-3px] mb-24 uppercase text-black">ONE-STOP SERVICE</h2>
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-x-24 gap-y-32">
          {products.map(card => (
            <div key={card.name} className="bg-black rounded-[40px] h-72 relative flex items-center overflow-visible group cursor-pointer hover:scale-[1.02] transition-all">
      ...
      {/* SECTION 4: GLOBAL PROJECT PORTFOLIO (PURIFIED) */}
      <section className="relative h-[600px] bg-black overflow-hidden flex items-end justify-center pb-24">
        <img src="https://sc02.alicdn.com/kf/H0daa452f96124bb8820b9c7800aa6382v.jpg" className="absolute inset-0 w-full h-full object-cover" alt="Portfolio" />
