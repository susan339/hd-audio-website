  ...
  return (
    <div className="bg-white selection:bg-[#2563EB] selection:text-white">
      ...
      <section className="relative h-screen bg-black overflow-hidden flex items-center">
        ...
        {/* Top Right Specs */}
        <div className="absolute top-10 right-16 z-20 text-gray-400 text-2xl font-normal tracking-[0.2em] hidden lg:block uppercase">21” | 18” | 15”</div>
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto w-full px-12 pt-20">
          <div className="max-w-5xl">
            ...
            <h1 className="text-[96px] font-black leading-[1] tracking-[-4.8px] mb-10 uppercase text-white/20" style={{WebkitTextStroke: '1px rgba(255,255,255,0.3)'}}>DRIVERS & SYSTEMS</h1>
            ...
            <div className="flex gap-6">
              ...
              <button onClick={() => window.location.href='https://wa.me/8615521083699'} className="border-2 border-white text-white px-12 py-5 font-bold text-sm tracking-[0.2em] uppercase hover:bg-white hover:text-black">ABOUT US</button>
            </div>
          </div>
          <div className="absolute right-12 bottom-1/2 translate-y-1/2 hidden lg:flex flex-col items-end gap-2 border-r-[3px] border-[#2563EB] pr-6">
             ...
             <span className="text-[#2563EB] font-bold text-xs tracking-[0.4em] uppercase">TRANSDUCERS // 18"</span>
          </div>
        </div>
      </section>
