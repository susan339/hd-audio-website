...
export default function HomePage() {
  ...
  return (
    <div className="bg-white selection:bg-[#2563EB] selection:text-white">
      {/* SECTION 1: HERO - Clean Mirror (Deleted side branding) */}
      <section className="relative h-screen bg-black overflow-hidden flex items-center">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto w-full px-12">
          <div className="max-w-5xl">
            {/* Specs文字下移：增加 mt-20 确保不遮挡顶部背景Logo */}
            <div className="text-gray-500 text-[24px] font-normal tracking-[0.25em] uppercase mb-12 mt-20">21” | 18” | 15”</div>
      ...
      {/* SECTION 3: ONE-STOP SERVICE (4 CARDS) */}
      ...
      {/* SECTION 4: PROJECT PORTFOLIO - No Extra Text, No Map (Fixed Duplicates) */}
