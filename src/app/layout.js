  ...
  return (
    <html lang="en">
      <body className={inter.className}>
          ...
          <div className="container mx-auto px-6 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <a 
                ...
                className="flex items-center justify-center w-9 h-9 bg-[#25D366] rounded-full hover:scale-110 transition-transform shadow-md"
        ...
        >
          <div className="bg-white text-black text-[11px] font-bold px-3 py-1.5 rounded-lg mr-3 shadow-xl opacity-0 group-hover:opacity-100 transition-opacity translate-x-2 group-hover:translate-x-0 transition-all">
            Chat on WhatsApp
          </div>
