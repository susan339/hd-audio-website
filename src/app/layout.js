          ...
          <div className="container mx-auto px-6 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <a 
                ...
                className="flex items-center justify-center w-10 h-10 bg-[#25D366] rounded-full hover:scale-110 transition-transform shadow-md"
