...
const InquiryModal = ({ isOpen, onClose, whatsappNumber }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[1000] flex items-center justify-center px-4 bg-black/70 backdrop-blur-md">
      <div className="bg-white w-full max-w-lg p-10 shadow-2xl rounded-sm border-t-8 border-[#2563EB] relative text-black">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button type="submit" className="w-full bg-black text-white font-bold py-5 uppercase tracking-[0.4em] text-[11px] hover:bg-blue-600 transition-all shadow-xl">Submit to WhatsApp</button>
        </form>
      </div>
    </div>,
    document.body
