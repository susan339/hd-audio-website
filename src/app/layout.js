  ...
  return (
    <html lang="en">
      ...
      <body className="antialiased m-0 p-0 bg-white">
        ...
        {children}
        {/* Footer */}
        <footer className="bg-black py-16 text-white px-8 border-t border-zinc-900">
          <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-center">
            <div className="font-black text-[15px] tracking-tight uppercase flex items-center gap-3">
