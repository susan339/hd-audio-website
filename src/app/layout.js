  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="CORETONE AUDIO is a leading professional speaker manufacturer specializing in high-end subwoofers, LF drivers, HF drivers, and coaxial speakers. OEM/ODM services available." />
        <meta name="keywords" content="professional audio drivers, high end subwoofer, LF drivers, HF drivers, coaxial speakers, speaker manufacturer, OEM audio" />
      </head>
