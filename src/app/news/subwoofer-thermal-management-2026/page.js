  ...
  return (
    <div className="min-h-screen bg-white text-black pt-32 pb-24 px-6">
      <div className="max-w-3xl mx-auto">
        <a href="/news" className="inline-flex items-center text-[10px] font-bold uppercase tracking-widest text-[#2563EB] mb-12 hover:gap-2 transition-all">
        ...
        <div className="prose prose-zinc max-w-none font-medium text-zinc-700 leading-relaxed space-y-8">
          ...
          <img src="https://sc02.alicdn.com/kf/A78ae9eb6e6874da09992e68402a8180fQ.png" alt="18TBX100" className="w-full bg-zinc-50 border border-zinc-100 p-8 my-12" />
          ...
          <section className="bg-zinc-900 text-white p-10 rounded-sm">
            <h3 className="text-xl font-black uppercase mb-4 text-[#2563EB]">Technical Specs Recap</h3>
            <ul className="grid grid-cols-2 gap-4 text-xs font-mono tracking-widest uppercase">
